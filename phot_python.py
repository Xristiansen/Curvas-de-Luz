# -*- coding: utf-8 -*-
###################################################################
# Fotometria de imágenes IRAC/SPITZER                             #
...
import numpy as np
archivo_catalogo = os.path.join(os.getcwd(), "datos_gaia3edr.csv") 
...
for foc in filtro_final.keys():
    ...
    final_obs_table.write(f'{final_dir}Algol_{foc}.csv', overwrite=True)    
